...
/**
 * <p>Java class for getT43RFWInput complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="getT43RFWInput">
 *   &lt;complexContent>
 ...
 *         &lt;element name="flashwareObjects" type="{http://bomDbServices.eng.dai/}flashwareObjects" minOccurs="0"/>
 *         &lt;element name="lowerFlashware" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "getT43RFWInput", propOrder = {
        "queryName",
...
public class GetT43RFWInput {
    ...
    protected FlashwareObjects flashwareObjects;
    @XmlElement(nillable = true)
    protected List<String> lowerFlashware;
    ...
    /**
     * Gets the value of the flashwareObjects property.
     *
     * @return possible object is
     * {@link FlashwareObjects }
     */
    public FlashwareObjects getFlashwareObjects() {
        return flashwareObjects;
    }

    /**
     * Sets the value of the flashwareObjects property.
     *
     * @param value allowed object is
     *              {@link FlashwareObjects }
     */
    public void setFlashwareObjects(FlashwareObjects value) {
        this.flashwareObjects = value;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the lowerFlashware property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLowerFlashware().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     * {@link String }
     */
    public List<String> getLowerFlashware() {
        if (lowerFlashware == null) {
            lowerFlashware = new ArrayList<String>();
        }
        return this.lowerFlashware;
    }
