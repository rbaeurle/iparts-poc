...
/**
 * Erweiterung von {@link EtkDataObject} um iParts-spezifische Methoden und Daten für Tabelle TABLE_DA_HMMSMDESC.
 */
public class iPartsDataHmMSmDesc extends EtkDataObject implements iPartsConst {

    static private final String[] KEYS = new String[]{ FIELD_DH_SERIES_NO, FIELD_DH_HM, FIELD_DH_M, FIELD_DH_SM };

    public iPartsDataHmMSmDesc(EtkProject project, HmMSmId id) {
        super(KEYS);
        tableName = TABLE_DA_HMMSMDESC;
        if (project != null) {
            init(project);
        }
