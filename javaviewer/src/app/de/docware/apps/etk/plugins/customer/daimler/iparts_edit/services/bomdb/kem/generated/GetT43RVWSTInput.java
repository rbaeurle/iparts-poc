...
/**
 * <p>Java class for getT43RVWSTInput complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="getT43RVWSTInput">
 *   &lt;complexContent>
 ...
 *         &lt;element name="usageLocations" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "getT43RVWSTInput", propOrder = {
        "queryName",
...
public class GetT43RVWSTInput {
    ...
    @XmlElement(nillable = true)
    protected List<String> usageLocations;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the usageLocations property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUsageLocations().add(newItem);
     * </pre>
     *
     *
     * <p>
    ...
    public List<String> getUsageLocations() {
        if (usageLocations == null) {
            usageLocations = new ArrayList<String>();
        }
